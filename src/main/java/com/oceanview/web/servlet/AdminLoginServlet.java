...
public class AdminRoomTypeServlet extends HttpServlet {
    ...
    // ✅ Recommended: keep jspx under WEB-INF/views
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            // redirect with error msg (URL encode basic)
            String msg = urlEncode(e.getMessage());
            resp.sendRedirect(req.getContextPath() + "/admin/roomtypes?msg=error&error=" + msg);
        }
    }
